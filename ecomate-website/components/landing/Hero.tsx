      ...
      <div style={{ 
        ...
        <h1 style={{ 
          ...
          <span style={{
            ...
            fontStyle: 'normal', lineHeight: 1.1,
        ...
        <div style={{ 
          ...
          <Link href="/contact" className="btn-primary" style={{ fontSize: 15, padding: '15px 32px', textDecoration: 'none' }}>
            {t('bookDemo')}
          ...
          <a href="#ai-section" style={{
            ...
            color: 'var(--text-sub)', background: 'rgba(255,255,255,0.03)',
            border: '1px solid rgba(255,255,255,0.1)', borderRadius: 12, padding: '15px 28px',
            transition: 'all .25s', backdropFilter: 'blur(12px)', cursor: 'pointer',
            textDecoration: 'none',
          }}>
