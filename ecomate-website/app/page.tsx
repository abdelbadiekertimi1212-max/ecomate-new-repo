...
export const metadata: Metadata = {
  title: 'EcoMate — The All-in-One AI Sales & Fulfillment OS 🇩🇿',
  description: 'Scale your Algerian business with AI sales automation. Connect Instagram, Facebook, and WhatsApp orders directly to your dashboard and Yalidine fulfillment.',
